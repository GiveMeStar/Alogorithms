...
public class common {
    ...
    public byte[] getInitializationVectorCFB() {
    ...
    public byte[] permute(byte[] input, int[] mapping) {
    ...
    public byte[][] getSubKeys(byte[] masterKey) {
    ...
    public byte[] split(byte[] input, int length) {
    ...
    public byte[] rotateLeft(byte[] input, int step, int length) {
    ...
    public byte[] getBits(byte[] input, int startPos, int length) {
        int noOfBytes = (length-1)/8 + 1;
        byte[] output = new byte[noOfBytes];
        for (int i = 0 ; i < length ; i++) {
    ...
    public byte[] concatBits(byte[] one, int oneLength,
    ...
    public void setBitInArray(byte[] input, int pos, int value) {
        int bytePos = pos / 8;
        int bitPos = pos % 8;
    ...
    public int getBitFromArray(byte[] array, int pos) {
        int value;
        int bytePos = pos / 8;
        int bitPos = pos % 8;
    ...
    public byte[] performXOR(byte[] one, byte[] two) {
